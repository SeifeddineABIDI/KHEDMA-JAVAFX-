...
import Servicefreelancer.Servicefreelancer;
import User.Entities.User;
import User.Entities.freelancer;
import User.Services.ServiceUser;
 ...
 * @author donia
 */
public class AddFlancerController1 implements Initializable {
  ...
  if (phone.getText().length()!=8){
        ...
        freelancer pv = new freelancer(ametier,anom, aprenom,acin,role, amail, amdp,adr ,aphone) ; 
         sf.add(pv);
         closeStage();
    }
private void handleEditOperation(){
    freelancer us = new freelancer(metier.getText(),id ,nom.getText(), prenom.getText(),Integer.parseInt(phone.getText()),role ,mail.getText(),mdp.getText(),adresse.getText(),Integer.parseInt(phone.getText())) ;
