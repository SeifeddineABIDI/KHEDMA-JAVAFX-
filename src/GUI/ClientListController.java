 ...
 Serviceclient su = new Serviceclient() ;
    ...
    private void loadData() {
        ...
        try {
            ...
            while(result.next()) {
                list.add(new client(result.getInt("id"), result.getString("nom"), result.getString("prenom"),result.getInt("cin"),result.getString("domaine"), result.getString("email"), result.getString("mdp"), result.getString("adresse"), result.getInt("telephone")));    
            }
