...
public class ProjetClientController implements Initializable {
  ...
  private Stage getStage() {
        return (Stage) freelancerField.getScene().getWindow();
    }
...
String gUserName = freelancerField.getText();
...
//    String client = clientField.getText();
    ...
    if (projectName.trim().isEmpty() || freelancer.trim().isEmpty() || domaine.trim().isEmpty()) {
       ...
       System.out.println(p);
        ...
        Globals.currentUser.setGithubtoken(GitToken.getText());
