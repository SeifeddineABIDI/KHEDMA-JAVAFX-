...
public class AdminListController implements Initializable {
    ...
    @FXML
    private TableColumn<User, String> GNameCol;
    @FXML
    ...
    private void initCol() {
        ...
        GNameCol.setCellValueFactory(new PropertyValueFactory<>("GUserName"));
    ...
    private void handlePlaceEdit(ActionEvent event) {
        ...
        try {
            ...
            inscriptionController controller = (inscriptionController) loader.getController();
