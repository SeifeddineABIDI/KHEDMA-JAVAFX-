...
String res;
    ...
    String maile;
       ...
       verif=lst.contains(maile);
        ...
        insert_image.setOnMouseClicked(Cfile);  
       ...
       if (verif==true){
        ...
        if ( anom.isEmpty() || aprenom.isEmpty()  || amail.isEmpty() || amdp.isEmpty() || adr.isEmpty()|| cin.getText().isEmpty() || phone.getText().isEmpty() || gname.isEmpty()  ){
  ...
  }else
  {
     ...
     client pv = new client(anom, aprenom,acin,adom,value, amail, doHashing(amdp),adr ,aphone,pi1,gname) ; 
         sc.add(pv);
