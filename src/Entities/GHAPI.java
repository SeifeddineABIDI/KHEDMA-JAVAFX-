...
public class GHAPI {
    ...
    private static final String REPO_OWNER = Globals.currentUser.getCurrentUserGithub();
    private static final String REPO_NAME = "khedmaprojects";
    ...
    GitHub github = new GitHubBuilder().withOAuthToken(Globals.currentUser.getGithubtoken()).build();
    //System.out.print(Globals.currentUser.getGithubtoken());
    GHRepository repo = github.getRepository(REPO_OWNER + "/" + REPO_NAME);
...
public static void inviteCollaboratorByEmail(String email, String permission) throws Exception {
    ...
    conn.setRequestProperty("Authorization", "token " + Globals.currentUser.getGithubtoken());
