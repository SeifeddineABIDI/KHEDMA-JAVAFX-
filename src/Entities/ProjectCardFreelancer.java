...
import static Entities.GHAPI.createFileInFolderInRepo;
 ...
 * @author azers
 */
public class ProjectCardFreelancer extends VBox {
    
    ActionEvent event = new ActionEvent();
    
    
      public ProjectCardFreelancer(Projet P) {
        ...
        // Create a button for deleting the project
                ...
                Button UploadtaskButton = new Button("Uplaod files");
    UploadtaskButton.setStyle("-fx-background-color: #4CAF50; -fx-text-fill: white; -fx-font-size: 14;");
    UploadtaskButton.setOnAction(e -> {
        // Load the FXML file
        ...
        if (selectedFile != null) {
            ...
            String Pathtofile = selectedFile.getAbsolutePath();
               try {
            createFileInFolderInRepo(Pathtofile, P.getNom());
...
viewTasksButton.setOnAction(e -> {
    try {
        CurrentProjectData.currentProjectId = P.getId();
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/GUI/Showtasks.fxml"));
...
githubButton.setOnAction(e -> {
    ...
    try {
        ...
        detailsBox.getChildren().addAll(nameLabel, domainLabel, freelancerLabel, clientLabel,viewTasksButton,githubButton,UploadtaskButton);
